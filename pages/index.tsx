...
export default function Home({ posts }: Props) {
  ...
  const structuredData = {
    ...
    "@type": "Organization",
    name: "Pramuka SMPN 2 Wonoayu",
    legalName: "Pramuka SMPN 2 Wonoayu",
    url: "http://pramuka2wonoayu.my.id",
    logo: "http://pramuka2wonoayu.my.id/logo.svg",
    foundingDate: "2022",
    founders: [
      {
        "@type": "Person",
      ...
      {
        "@type": "Person",
        name: "Wahyu Dwi Pamungkas",
      },
    ],
    address: {
      "@type": "PostalAddress",
      streetAddress: "SMP Negeri 2 Wonoayu",
    ...
    sameAs: [
      ...
      "https://www.instagram.com/pramuka2wonoayu",
    ],
  };
  ...
  return (
    <main className={`relative ${inter.className} text-brandblue-700`}>
      <Head>
        <title key="title">Pramuka SMPN 2 Wonoayu | PRAMUDAYU</title>
        <meta
          key="desc"
          name="description"
          content="Pramuka SMPN 2 Wonoayu | PRAMUDAYU"
        />
        <meta
          key="ogtitle"
          property="og:title"
        ...
        <meta
          key="ogimage"
          property="og:image"
          content="https://pramuka2wonoayu.my.id/opengraph-main.png"
        />
        <meta
          key="ogimagealt"
        ...
        <meta
          key="twturl"
          name="twitter:url"
          content={`https://pramuka2wonoayu.my.id${currentUrl}?utm_source=twitter&utm_medium=social`}
        />
        <meta
          key="twtimage"
      ...
      >
        ...
        >
          <h1 className="text-center text-white">
            Portal Berita dan Informasi Pramuka 2 Wonoayu
          </h1>
        </div>
      </section>
      <FrontHeader />
